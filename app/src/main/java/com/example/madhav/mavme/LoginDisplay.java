    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent("com.example.madhav.mavme.RegistrationDisplay");
                startActivity(i);
            }
        });
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (uID >= 0) {
                    ...
                    if (uID == -2)
                        Utils.alertDialog(context, "This account has been deactivated. Please contact the system administrator to re-activate.",
                                new Utils.dialogHandler() {
                                    @Override
                                    public void onButtonClick(boolean click) {
                                    }
